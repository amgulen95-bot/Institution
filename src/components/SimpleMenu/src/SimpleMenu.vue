...
<script lang="ts" setup>
  ...
  const getShowActiveIndicator = computed(() => props.isSplitMenu && !props.collapse);
  ...
  function updateActiveIndicator() {
    ...
    nextTick(() => {
      ...
      const activeEl = wrapper.querySelector(
        '.vben-menu-vertical > .vben-menu-item-active:not(.vben-menu-submenu), .vben-menu-vertical .vben-menu-submenu .vben-menu-item-active:not(.vben-menu-submenu)',
      ) as HTMLElement | null;
